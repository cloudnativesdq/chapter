...
Bienvenidos al repositorio oficial del **Chapter de Cloud Native Santo Domingo (Cloud Native SDQ)**. Somos una comunidad local oficial de la **Cloud Native Computing Foundation (CNCF)** en la República Dominicana, dedicada a la difusión, educación y adopción de tecnologías cloud-native, Kubernetes y la cultura del código abierto.
...
*   🌐 **Sitio Web Oficial:** mira nuestros últimos meetups y recursos en [cloudnativesdq.org](https://cloudnativesdq.org). [Repositorio](https://github.com/cloudnativesdq/website)
...
## 📚 Manuales Operativos y Playbooks
...
¡Esta comunidad se construye entre todos! Si deseas mejorar nuestras guías de eventos o colaborar con el sitio web:
1. Crea un fork del repositorio correspondiente.
2. Realiza tus cambios en una rama local descriptiva.
3. Envía un Pull Request para revisión del Staff (consulta el archivo **[OWNERS](file:///Users/tineoc/Documents/Code/chapter/OWNERS)** para saber quiénes son los aprobadores y revisores autorizados).

> [!IMPORTANT]
> Todos los miembros, voluntarios, ponentes y colaboradores deben cumplir estrictamente con el **[Código de Conducta de la CNCF](https://github.com/cncf/foundation/blob/main/code-of-conduct-languages/es/code-of-conduct-es.md)** en todas nuestras actividades presenciales y canales virtuales.
